...
do
  ...
  do
      ...
      do
        ...
        then
          TEST1="$var $var2 $var3 for s21_grep.c s21_grep.h"
          echo "$TEST1"
          ...
          TEST3="$var $var2 $var3 -e for -e ^int s21_grep.c s21_grep.h"
          echo "$TEST3"
          ...
          TEST6="$var $var2 $var3 -e while -e void -f pattern.txt s21_grep.c"
          echo "$TEST6"
